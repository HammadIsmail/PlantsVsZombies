...
namespace PlantsVsZombies
{
    public partial class Level3Form : Form
    {
        ...
        private void ZombiesMovement_Tick(object sender, EventArgs e)
        {
           ...
           Zombie = Zombies.Movement(ref ZombieAlive, Zombie, rand,3);
        ...
        {
            GameOver.lose( LevelCompletionBar,  levelBarIconPb,  Flag,  level,  Zombie,  PictureBox1,  PictureBox2,  PictureBox3,  PictureBox4,  PictureBox5,3);
        ...
        private void Level1Form_Load(object sender, EventArgs e)
        {
            ...
            PeaFire = Properties.Resources.fireball;
            //   peaShooter = PlantsVsZombies.Properties.Resources.PeashooterTransparentGif_391kb;
            peaShooter = PlantsVsZombies.Properties.Resources.FireShooter;
